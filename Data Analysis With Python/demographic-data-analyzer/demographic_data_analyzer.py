...
def calculate_demographic_data(print_data=True):
    ...
    df_over_50k = df[df['salary'].isin(['>50K'])]
    ...
    higher_education_rich = (higher_education['salary'].value_counts(normalize=True).get('>50K', 0) * 100)
    lower_education_rich = (lower_education['salary'].value_counts(normalize=True).get('>50K', 0) * 100)
    ...
    rich_percentage = (df[df['hours-per-week'] == min_work_hours]['salary'].value_counts(normalize=True).get('>50K', 0) * 100)
